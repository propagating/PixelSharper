...
[TestFixture]
public class PixelConstructionTests
{
    [Test]
...
[TestFixture]
public class PixelArithmeticTests
{
    [Test]
...
public class PixelOtherTests
{
    ...
    [Test]
    public void LinearInterpolation_Halfway_ReturnsAveragePixel()
    {
        var a = new Pixel(0, 0, 0, 255);
        var b = new Pixel(255, 255, 255, 255);
        var result = Pixel.LinearInterpolation(a, b, 0.5f);

        Assert.That(result.Red, Is.EqualTo(127).Within(1));
        Assert.That(result.Green, Is.EqualTo(127).Within(1));
        Assert.That(result.Blue, Is.EqualTo(127).Within(1));
